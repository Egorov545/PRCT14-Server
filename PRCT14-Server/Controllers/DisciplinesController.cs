...
namespace PRCT14_Server.Controllers
{
    ...
    public class DisciplinesController : ControllerBase
    {
        ...
        public DisciplinesController(CollegeContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != discipline.DisciplineCode)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Discipline>> PostDiscipline(Discipline discipline)
        {
            ...
            return CreatedAtAction("GetDiscipline", new { id = discipline.DisciplineCode }, discipline);
        }
        ...
        {
            return _context.Disciplines.Any(e => e.DisciplineCode == id);
        }
    }
}
